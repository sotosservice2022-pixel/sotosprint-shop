...
const DEFAULT_SETTINGS = {
  ...
  // Сортування товарів для покупця. Дропдаун над каталогом. Закріплені (pinTop) завжди зверху.
  ...
  checkoutMaxWidth: 600,
  // AI-опис товару з фото (безкоштовна текстова Gemini). Кнопка в редакторі товару;
  // нічого не застосовується автоматично — адмін сам обирає, що вставити. Вимкнено за замовч.
  aiDescribeEnabled: false,
  aiDescribeModel: '', // текстова модель Gemini для опису ('' = дефолт gemini-3.5-flash на бекенді)
  ...
  pwaIconPresets: [],                // збережені іконки на вибір [{icon, mask}] — щоб не завантажувати щоразу
  ...
  inCartClickNothing: false,   // якщо товар вже в кошику — клік нічого не робить (найвищий пріоритет)
  inCartClickNothingMobile: false, // те саме але для мобільного (≤700px)
